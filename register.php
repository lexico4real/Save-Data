                        ...
                        <div class="row">
                            ...
                            <div class="dragArea col-lg-4">
                                ...
                                <div class="col-md-12 form-group " data-for="address2">
                                    <input type="text" name="address2" placeholder="Address Field 2" data-form-field="address2" class="form-control px-3 display-7" id="address2-header15-f" value="<?php if (isset($_POST['address2'])) echo $_POST['address2']; ?>">
                                </div>
                                <div class="col-md-12 form-group " data-for="city">
                                    <input type="text" name="city" placeholder="City" data-form-field="City" required="required" class="form-control px-3 display-7" id="city-header15-f" value="<?php if (isset($_POST['city'])) echo $_POST['city']; ?>">
                                </div>
                                <div class="col-md-12 form-group " data-for="state">
                                    <input type="text" name="state" placeholder="State" data-form-field="state" required="required" class="form-control px-3 display-7" id="state-header15-f" value="<?php if (isset($_POST['state'])) echo $_POST['state']; ?>">
                                </div>
                                
                            </div>
                            <div class="dragArea col-lg-4">
                                <div class="col-md-12 form-group " data-for="country">
                                    <input type="text" name="country" placeholder="Country" data-form-field="Country" required="required" class="form-control px-3 display-7" id="country-header15-f" value="<?php if (isset($_POST['country'])) echo $_POST['country']; ?>">
                                    <input type="hidden" id="latitude_input" />
                                    <input type="hidden" id="longitude_input" />
                                </div>
                                <div class="col-md-12 form-group " data-for="phone1">
                                    <input type="phone1" name="phone1" placeholder="Phone Number 1" data-form-field="phone1" required="required" class="form-control px-3 display-7" id="phone1-header15-f" value="<?php if (isset($_POST['phone1'])) echo $_POST['phone1']; ?>">
                                </div>
                                <div class="col-md-12 form-group " data-for="phone2">
                                    <input type="text" name="phone2" placeholder="Phone Number 2" data-form-field="phone2" class="form-control px-3 display-7" id="phone2-header15-f" value="<?php if (isset($_POST['phone2'])) echo $_POST['phone2']; ?>">
                                </div>
                                <div class="col-md-12 form-group " data-for="nok">
                                    <input type="text" name="nok" placeholder="Next of Kin" data-form-field="nok" required="required" class="form-control px-3 display-7" id="nok-header15-f" value="<?php if (isset($_POST['nok'])) echo $_POST['nok']; ?>">
                                </div>
